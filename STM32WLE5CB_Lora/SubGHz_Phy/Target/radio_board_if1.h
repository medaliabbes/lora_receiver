...
/* USER CODE BEGIN Exported PinMapping */
		...
		#define RF_SW1_GPIO_CLK_ENABLE()		__HAL_RCC_GPIOA_CLK_ENABLE()
		#define RF_SW1_GPIO_CLK_DISABLE()		__HAL_RCC_GPIOA_CLK_DISABLE()

		#define RF_SW2_PIN						GPIO_PIN_0
		#define RF_SW2_GPIO_PORT				GPIOB
		#define RF_SW2_GPIO_CLK_ENABLE()		__HAL_RCC_GPIOB_CLK_ENABLE()
		#define RF_SW2_GPIO_CLK_DISABLE()		__HAL_RCC_GPIOB_CLK_DISABLE()
