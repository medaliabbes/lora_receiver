...
int32_t RBI_Init(void)
{
  ...
  //#warning user to provide its board code or to call his board driver functions
	  ...
	  RF_SW1_GPIO_CLK_ENABLE();
	  RF_SW2_GPIO_CLK_ENABLE();
	  //Configure the Radio Switch pin
	  gpio_init_structure.Pin   = RF_SW2_PIN;
	  gpio_init_structure.Mode  = GPIO_MODE_OUTPUT_PP;
	  gpio_init_structure.Pull  = GPIO_NOPULL;
	  gpio_init_structure.Speed = GPIO_SPEED_FREQ_VERY_HIGH;

	  HAL_GPIO_Init(RF_SW2_GPIO_PORT, &gpio_init_structure);

	  gpio_init_structure.Pin = RF_SW1_PIN;
	  HAL_GPIO_Init(RF_SW1_GPIO_PORT, &gpio_init_structure);

	  HAL_GPIO_WritePin(RF_SW2_GPIO_PORT, RF_SW2_PIN, GPIO_PIN_RESET);
	  HAL_GPIO_WritePin(RF_SW1_GPIO_PORT, RF_SW1_PIN, GPIO_PIN_RESET);

	  return 0;	//POSIBLE CONFLICT HERE
...
int32_t RBI_DeInit(void)
{
  ...
  /* USER CODE BEGIN RBI_DeInit_2 */
	...
	//#warning user to provide its board code or to call his board driver functions
	  ...
	  HAL_GPIO_DeInit(RF_SW2_GPIO_PORT, RF_SW2_PIN);
	  HAL_GPIO_DeInit(RF_SW1_GPIO_PORT, RF_SW1_PIN);
	  ...
	  switch (Config)
	  {
		...
		case RBI_SWITCH_RX:
		{
		  /*Turns On in Rx Mode the RF Switch */
			  HAL_GPIO_WritePin(RF_SW1_GPIO_PORT, RF_SW1_PIN, GPIO_PIN_RESET);
			  HAL_GPIO_WritePin(RF_SW2_GPIO_PORT, RF_SW2_PIN, GPIO_PIN_SET);
		  break;
		}
		case RBI_SWITCH_RFO_LP:
		{
		  /*Turns On in Tx Low Power the RF Switch */
			  HAL_GPIO_WritePin(RF_SW1_GPIO_PORT, RF_SW1_PIN, GPIO_PIN_SET);
			  HAL_GPIO_WritePin(RF_SW2_GPIO_PORT, RF_SW2_PIN, GPIO_PIN_RESET);
		  break;
		}
